...
function getFallbackSymptomAnalysis($symptoms, $details) {
    ...
    // Emergency patterns
    $emergencyPatterns = 'đau ngực|khó thở|tím tái|bất tinh|bất tỉnh|co giật|liệt|nói khó|méo miệng|đau đầu dữ dội|nôn ra máu|chảy máu nhiều|ngất|mất trí nhớ|run tay|run chân|lú lẫn|tê liệt|tê bì|mất ý thức|hoang tưởng|ảo giác|mất thăng bằng|nhìn đôi|tê nửa người|yếu nửa người|đột quỵ|tai biến|co cứng';

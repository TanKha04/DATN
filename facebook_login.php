...
if (!FACEBOOK_APP_ID || !FACEBOOK_APP_SECRET) {
    ...
    echo '<div class="container py-5"><div class="alert alert-warning">Facebook Login chưa được cấu hình. Vui lòng thêm FACEBOOK_APP_ID và FACEBOOK_APP_SECRET vào cấu hình.</div></div>';
    require_once 'footer.php';
    exit;
}

// Function to render Facebook errors nicely
...
// Check if we are receiving the authorization code (callback phase)
if (isset($_GET['code'])) {
    $state = $_GET['state'] ?? '';
    ...
    $redirectUri = site_url('facebook_login.php');
    ...
    try {
        ...
        $pdo->rollBack();
        error_log('facebook_login callback error: ' . $e->getMessage());

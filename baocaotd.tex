...
\begin{itemize}
    \item \textbf{Giao diện thân thiện:} Thiết kế đơn giản, trực quan, dễ sử dụng cho bệnh nhân lớn tuổi
    \item \textbf{Responsive:} Hiển thị tốt trên cả máy tính và thiết bị di động
    \item \textbf{Xác minh sinh viên:} Cơ chế kiểm duyệt thẻ sinh viên bởi Admin giúp tăng độ tin cậy và an toàn
    \item \textbf{Giao tiếp đa phương thức:} Tích hợp thành công cuộc gọi Video Call WebRTC giúp trao đổi trực quan bệnh trạng từ xa
    \item \textbf{Tích hợp AI thông minh:} Trợ lý ảo AI (BlenderBot/Gemini) hỗ trợ giải đáp y học cơ bản 24/7
    \item \textbf{Quản lý chuyên nghiệp:} Tự động hóa tạo lịch hẹn và ghi nhật ký kiểm toán hệ thống tăng bảo mật thông tin
    \item \textbf{Quản trị đầy đủ:} Trang Admin Dashboard mạnh mẽ kiểm soát toàn bộ bài đăng và người dùng
\end{itemize}
...
\begin{itemize}
    ...
    \item Chưa tích hợp bản đồ (Google Maps) để tìm kiếm theo bán kính vị trí thực tế
\end{itemize}
...
\begin{itemize}
    ...
    \item Phát triển hệ thống xác minh thẻ sinh viên nghiêm ngặt đảm bảo độ tin cậy cho cộng đồng.
    \item Tích hợp thành công cuộc gọi điện thoại và cuộc gọi Video trực tuyến thời gian thực qua công nghệ WebRTC.
    \item Tích hợp Trợ lý ảo AI Chatbot (sử dụng APIs Hugging Face/Gemini) hỗ trợ giải đáp y học cơ bản và vận hành hệ thống 24/7.
    \item Hoàn thành hệ thống đặt lịch hẹn y tế (Appointments) tự động sau khi tuyển dụng thành công.
    \item Tích hợp đầy đủ các tính năng giao tiếp: nhắn tin, kết bạn, đánh giá 2 chiều và báo cáo vi phạm.
    \item Hoàn thiện trang quản trị Admin Dashboard trực quan với đầy đủ chức năng quản lý.
\end{itemize}
...
\begin{itemize}
    \item Cung cấp giải pháp công nghệ cho vấn đề thực tế tại cộng đồng.
    \item Hỗ trợ sinh viên Y có thêm cơ hội thực hành lâm sàng thực tế ngoài bệnh viện và có thêm thu nhập.
    \item Giúp người có nhu cầu dễ dàng tìm được người chăm sóc phù hợp với chi phí hợp lý.
    \item Góp phần giảm tải cho hệ thống y tế công cộng.
\end{itemize}
...
\begin{itemize}
    \item Ứng dụng Machine Learning vào hệ thống gợi ý để tự động đề xuất sinh viên phù hợp nhất dựa trên bệnh lý của bệnh nhân.
    \item Tích hợp giao thức WebSocket để hỗ trợ nhắn tin và thông báo real-time.
    \item Tích hợp Google Maps API để hỗ trợ tìm kiếm và định vị sinh viên/bệnh nhân theo bán kính khu vực.
\end{itemize}
